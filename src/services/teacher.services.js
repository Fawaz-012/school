import { findTeacherByEmail, findTeacherById, saveTeacherDetails, updateTeacherDetails } from "../repository/teacher.repository.js"
...
    if(teacherExists) throw new Error(`Account already exists`);
